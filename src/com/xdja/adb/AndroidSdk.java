...
public class AndroidSdk {
	...
	public static File aapt() {
		...
		return new File(
				findLatestAndroidPlatformFolder(buildToolsFolder,
	...
	public static String androidJar() {
		...
		return new File(findLatestAndroidPlatformFolder(platformsFolder, "No installed Android APIs have been found."),
	...
	public static void main(String[] args) {
		System.out.println(AndroidSdk.adb().getAbsolutePath());
	}
}
